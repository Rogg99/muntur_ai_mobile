...
class Pay extends StatefulWidget {
  ...
  const Pay({super.key, required this.plan});
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  const Spacer(),
                  Text(
                    ' ${translator.days(widget.plan.days)}',
                    style: appStyle
              ...
              Row(
                ...
                children: [
                  ...
                  Spacer(),
                  Text(
                    '${widget.plan.price.toStringAsFixed(0)} ${widget.plan.currency}',
                    style: appStyle
                        .H5(color: Colors.grey)
                        .copyWith(decoration: TextDecoration.none),
                    textAlign: TextAlign.center,
                  ),
                  Padding(padding: getPadding(left: 20)),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Flexible(
                      child: Text(
                        translator.active_subscription_warning,
                        style: appStyle.H7(),
                        textAlign: TextAlign.center,
                      ),
                    ),
                          ...
                          children: [
                            Text(
                              ...
                              style: appStyle.txtRoboto(
                                  size: 20, color: UIColors.primaryAccent),
                            ),
                          ],
                        ),
                      ),
        ...
        return AlertDialog(
          content: Column(
            ...
            children: [
              ...
              Text(
                "Félicitations, vous avez completé votre achat avec succès !!!",
                style: appStyle.H5(),
                textAlign: TextAlign.center,
              ),
            ],
