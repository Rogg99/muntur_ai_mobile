...
class InfoView_ extends State<InfoView>  with TickerProviderStateMixin{
  ...
  WidgetCommentState linealComment = WidgetCommentState(comment: Comment(),parent: null) ;
  @override
  void initState() {
                  ...
                  Row(
                    ...
                    children: [
                      TextButton(
                        ...
                        child: Text('Afficher plus ',style: appStyle.H4(color: Colors.blueGrey,weight: 'bold'),),
                      )
                    ],
                  ),
                ):(isLoadingMore)?
                          ...
                          Padding(
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border(left: BorderSide(color: Theme.of(context).colorScheme.background,width: 4,)),
                              ),
                              child:
                              Row(
                                children: [
  ...
  sendReply()async{
    ...
    if(messagecontroller.text!='') {
      await NotificationApi().commentInfo(info!.id,replyTo).then((response) => {
        if(response.statusCode==200){
