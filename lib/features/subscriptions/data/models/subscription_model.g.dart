...
void _subscriptionModelSerialize(
  ...
  writer.writeLong(offsets[4], object.days);
...
SubscriptionModel _subscriptionModelDeserialize(
  ...
  object.days = reader.readLong(offsets[4]);
...
extension SubscriptionModelByIndex on IsarCollection<SubscriptionModel> {
  Future<SubscriptionModel?> getById(String id) {
    return getByIndex(r'id', [id]);
  }

  SubscriptionModel? getByIdSync(String id) {
  ...
  Future<List<SubscriptionModel?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<SubscriptionModel?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(SubscriptionModel object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(SubscriptionModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<SubscriptionModel> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<SubscriptionModel> objects,
      {bool saveLinks = true}) {
...
extension SubscriptionModelQueryWhereSort
  ...
  QueryBuilder<SubscriptionModel, SubscriptionModel, QAfterWhere> anyIsarId() {
...
extension SubscriptionModelQuerySortBy
  ...
  QueryBuilder<SubscriptionModel, SubscriptionModel, QAfterSortBy> sortById() {
    return QueryBuilder.apply(this, (query) {
...
extension SubscriptionModelQueryWhereDistinct
  ...
  QueryBuilder<SubscriptionModel, SubscriptionModel, QDistinct> distinctByCode(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SubscriptionModel, SubscriptionModel, QDistinct> distinctById(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SubscriptionModel, SubscriptionModel, QDistinct> distinctByType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SubscriptionModelQueryProperty
  ...
  QueryBuilder<SubscriptionModel, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isarId');
    });
  }

  QueryBuilder<SubscriptionModel, bool, QQueryOperations> activeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'active');
    });
  }

  QueryBuilder<SubscriptionModel, String, QQueryOperations> codeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'code');
    });
  }

  QueryBuilder<SubscriptionModel, int, QQueryOperations> coinsProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SubscriptionModel, int, QQueryOperations> daysProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'days');
    });
  }

  QueryBuilder<SubscriptionModel, int, QQueryOperations> expiresAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'expiresAt');
    });
  }

  QueryBuilder<SubscriptionModel, String, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<SubscriptionModel, double, QQueryOperations> priceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'price');
    });
  }

  QueryBuilder<SubscriptionModel, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension GetSubscriptionPlanModelCollection on Isar {
  IsarCollection<SubscriptionPlanModel> get subscriptionPlanModels =>
      this.collection();
}

const SubscriptionPlanModelSchema = CollectionSchema(
  name: r'SubscriptionPlanModel',
  id: 853892421221065013,
  properties: {
    r'code': PropertySchema(
      id: 0,
      name: r'code',
  ...
  estimateSize: _subscriptionPlanModelEstimateSize,
  serialize: _subscriptionPlanModelSerialize,
  deserialize: _subscriptionPlanModelDeserialize,
  deserializeProp: _subscriptionPlanModelDeserializeProp,
  idName: r'isarId',
  indexes: {
    r'code': IndexSchema(
  ...
  links: {},
  embeddedSchemas: {},
  getId: _subscriptionPlanModelGetId,
  getLinks: _subscriptionPlanModelGetLinks,
  attach: _subscriptionPlanModelAttach,
  version: '3.1.0+1',
);

int _subscriptionPlanModelEstimateSize(
...
void _subscriptionPlanModelSerialize(
  SubscriptionPlanModel object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
SubscriptionPlanModel _subscriptionPlanModelDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = SubscriptionPlanModel();
  object.code = reader.readString(offsets[0]);
  object.currency = reader.readString(offsets[1]);
  object.days = reader.readLong(offsets[2]);
...
P _subscriptionPlanModelDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _subscriptionPlanModelGetId(SubscriptionPlanModel object) {
  return object.isarId;
}

List<IsarLinkBase<dynamic>> _subscriptionPlanModelGetLinks(
    SubscriptionPlanModel object) {
  return [];
}

void _subscriptionPlanModelAttach(
    IsarCollection<dynamic> col, Id id, SubscriptionPlanModel object) {
  object.isarId = id;
}

extension SubscriptionPlanModelByIndex
    on IsarCollection<SubscriptionPlanModel> {
  Future<SubscriptionPlanModel?> getByCode(String code) {
    return getByIndex(r'code', [code]);
  }

  SubscriptionPlanModel? getByCodeSync(String code) {
  ...
  Future<List<SubscriptionPlanModel?>> getAllByCode(List<String> codeValues) {
    final values = codeValues.map((e) => [e]).toList();
    return getAllByIndex(r'code', values);
  }

  List<SubscriptionPlanModel?> getAllByCodeSync(List<String> codeValues) {
    final values = codeValues.map((e) => [e]).toList();
  ...
  Future<Id> putByCode(SubscriptionPlanModel object) {
    return putByIndex(r'code', object);
  }

  Id putByCodeSync(SubscriptionPlanModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'code', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByCode(List<SubscriptionPlanModel> objects) {
    return putAllByIndex(r'code', objects);
  }

  List<Id> putAllByCodeSync(List<SubscriptionPlanModel> objects,
      {bool saveLinks = true}) {
    return putAllByIndexSync(r'code', objects, saveLinks: saveLinks);
  }
}

extension SubscriptionPlanModelQueryWhereSort
    on QueryBuilder<SubscriptionPlanModel, SubscriptionPlanModel, QWhere> {
  QueryBuilder<SubscriptionPlanModel, SubscriptionPlanModel, QAfterWhere>
      anyIsarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
...
extension SubscriptionPlanModelQueryWhere on QueryBuilder<SubscriptionPlanModel,
    SubscriptionPlanModel, QWhereClause> {
  QueryBuilder<SubscriptionPlanModel, SubscriptionPlanModel, QAfterWhereClause>
      isarIdEqualTo(Id isarId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IdWhereClause.between(
        lower: isarId,
...
extension SubscriptionPlanModelQueryFilter on QueryBuilder<
    SubscriptionPlanModel, SubscriptionPlanModel, QFilterCondition> {
  QueryBuilder<SubscriptionPlanModel, SubscriptionPlanModel,
...
extension SubscriptionPlanModelQueryObject on QueryBuilder<
    SubscriptionPlanModel, SubscriptionPlanModel, QFilterCondition> {}

extension SubscriptionPlanModelQueryLinks on QueryBuilder<SubscriptionPlanModel,
    SubscriptionPlanModel, QFilterCondition> {}

extension SubscriptionPlanModelQuerySortBy
    on QueryBuilder<SubscriptionPlanModel, SubscriptionPlanModel, QSortBy> {
  QueryBuilder<SubscriptionPlanModel, SubscriptionPlanModel, QAfterSortBy>
      sortByCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.asc);
    });
...
extension SubscriptionPlanModelQuerySortThenBy
    on QueryBuilder<SubscriptionPlanModel, SubscriptionPlanModel, QSortThenBy> {
  QueryBuilder<SubscriptionPlanModel, SubscriptionPlanModel, QAfterSortBy>
      thenByCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.asc);
...
extension SubscriptionPlanModelQueryWhereDistinct
    on QueryBuilder<SubscriptionPlanModel, SubscriptionPlanModel, QDistinct> {
  QueryBuilder<SubscriptionPlanModel, SubscriptionPlanModel, QDistinct>
...
extension SubscriptionPlanModelQueryProperty on QueryBuilder<
    SubscriptionPlanModel, SubscriptionPlanModel, QQueryProperty> {
  QueryBuilder<SubscriptionPlanModel, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isarId');
    });
  }

  QueryBuilder<SubscriptionPlanModel, String, QQueryOperations> codeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'code');
    });
  }

  QueryBuilder<SubscriptionPlanModel, String, QQueryOperations>
      currencyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'currency');
    });
  ...
  QueryBuilder<SubscriptionPlanModel, int, QQueryOperations> daysProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'days');
    });
  }
  ...
  QueryBuilder<SubscriptionPlanModel, double, QQueryOperations>
      priceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'price');
    });
  ...
  QueryBuilder<SubscriptionPlanModel, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'type');
    });
  }
